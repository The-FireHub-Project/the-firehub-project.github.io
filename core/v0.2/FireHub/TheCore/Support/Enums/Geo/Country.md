...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NEW_CALEDONIA = 'NC'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NEW_ZEALAND = 'NZ'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NICARAGUA = 'NI'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NIGER = 'NE'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NIGERIA = 'NG'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NIUE = 'NU'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NORFOLK_ISLAND = 'NF'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NORTH_KOREA = 'KP'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NORTH_VIETNAM = 'VD'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NORTHERN_MARIANA_ISLANDS = 'MP'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::NORWAY = 'NO'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::OMAN = 'OM'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PACIFIC_ISLANDS_TRUST_TERRITORY = 'PC'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PAKISTAN = 'PK'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PALAU = 'PW'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PALESTINIAN_TERRITORIES = 'PS'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PANAMA = 'PA'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PANAMA_CANAL_ZONE = 'PZ'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PAPUA_NEW_GUINEA = 'PG'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PARAGUAY = 'PY'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PEOPLES_DEMOCRATIC_REPUBLIC_OF_YEMEN = 'YD'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PERU = 'PE'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PHILIPPINES = 'PH'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PITCAIRN_ISLANDS = 'PN'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::POLAND = 'PL'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PORTUGAL = 'PT'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::PUERTO_RICO = 'PR'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::QATAR = 'QA'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::ROMANIA = 'RO'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::RUSSIA = 'RU'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::RWANDA = 'RW'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::REUNION = 'RE'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAINT_BARTHELEMY = 'BL'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAINT_HELENA = 'SH'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAINT_KITTS_AND_NEVIS = 'KN'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAINT_LUCIA = 'LC'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAINT_MARTIN = 'MF'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAINT_PIERRE_AND_MIQUELON = 'PM'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAINT_VINCENT_AND_THE_GRENADINES = 'VC'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAMOA = 'WS'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAN_MARINO = 'SM'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAUDI_ARABIA = 'SA'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SENEGAL = 'SN'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SERBIA = 'RS'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SERBIA_AND_MONTENEGRO = 'CS'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SEYCHELLES = 'SC'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SIERRA_LEONE = 'SL'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SINGAPORE = 'SG'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SLOVAKIA = 'SK'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SLOVENIA = 'SI'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SOLOMON_ISLANDS = 'SB'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SOMALIA = 'SO'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SOUTH_AFRICA = 'ZA'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SOUTH_GEORGIA_AND_THE_SOUTH_SANDWICH_ISLANDS = 'GS'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SOUTH_KOREA = 'KR'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SPAIN = 'ES'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SRI_LANKA = 'LK'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SUDAN = 'SD'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SURINAME = 'SR'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SVALBARD_AND_JAN_MAYEN = 'SJ'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SWAZILAND = 'SZ'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SWEDEN = 'SE'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SWITZERLAND = 'CH'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SYRIA = 'SY'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::SAO_TOME_AND_PRINCIPE = 'ST'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TAIWAN = 'TW'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TAJIKISTAN = 'TJ'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TANZANIA = 'TZ'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::THAILAND = 'TH'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TIMOR_LESTE = 'TL'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TOGO = 'TG'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TOKELAU = 'TK'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TONGA = 'TO'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TRINIDAD_AND_TOBAGO = 'TT'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TUNISIA = 'TN'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TURKEY = 'TR'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TURKMENISTAN = 'TM'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TURKS_AND_CAICOS_ISLANDS = 'TC'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::TUVALU = 'TV'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::US_MINOR_OUTLYING_ISLANDS = 'UM'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::US_MISCELLANEOUS_PACIFIC_ISLANDS = 'PU'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::US_VIRGIN_ISLANDS = 'VI'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::UGANDA = 'UG'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::UKRAINE = 'UA'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::UNION_OF_SOVIET_SOCIALIST_REPUBLICS = 'SU'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::UNITED_ARAB_EMIRATES = 'AE'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::UNITED_KINGDOM = 'GB'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::UNITED_STATES = 'US'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::URUGUAY = 'UY'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::UZBEKISTAN = 'UZ'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::VANUATU = 'VU'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::VATICAN_CITY = 'VA'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::VENEZUELA = 'VE'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::VIETNAM = 'VN'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::WAKE_ISLAND = 'WK'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::WALLIS_AND_FUTUNA = 'WF'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::WESTERN_SAHARA = 'EH'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::YEMEN = 'YE'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::ZAMBIA = 'ZM'
```
...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::ZIMBABWE = 'ZW'
```
...
```php
public \FireHub\TheCore\Support\Enums\Geo\Country::continent():\FireHub\TheCore\Support\Enums\Geo\Continent
```
