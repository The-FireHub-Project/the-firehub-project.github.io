...
<sub>_GIT: $Id: 09ec9e5681e62b41717cc02994334bb34debb68a $ Blob checksum._</sub><br>
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_FORT_NELSON = 'America/Fort_Nelson'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_FORTALEZA = 'America/Fortaleza'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_GLACE_BAY = 'America/Glace_Bay'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_GOOSE_BAY = 'America/Goose_Bay'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_GRAND_TURK = 'America/Grand_Turk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_GRENADA = 'America/Grenada'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_GUADELOUPE = 'America/Guadeloupe'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_GUATEMALA = 'America/Guatemala'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_GUAYAQUIL = 'America/Guayaquil'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_GUYANA = 'America/Guyana'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_HALIFAX = 'America/Halifax'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_HAVANA = 'America/Havana'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_HERMOSILLO = 'America/Hermosillo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INDIANA_INDIANAPOLIS = 'America/Indiana/Indianapolis'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INDIANA_KNOX = 'America/Indiana/Knox'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INDIANA_MARENGO = 'America/Indiana/Marengo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INDIANA_PETERSBURG = 'America/Indiana/Petersburg'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INDIANA_TELL_CITY = 'America/Indiana/Tell_City'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INDIANA_VEVAY = 'America/Indiana/Vevay'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INDIANA_VINCENNES = 'America/Indiana/Vincennes'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INDIANA_WINAMAC = 'America/Indiana/Winamac'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_INUVIK = 'America/Inuvik'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_IQALUIT = 'America/Iqaluit'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_JAMAICA = 'America/Jamaica'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_JUNEAU = 'America/Juneau'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_KENTUCKY_LOUISVILLE = 'America/Kentucky/Louisville'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_KENTUCKY_MONTICELLO = 'America/Kentucky/Monticello'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_KRALENDIJK = 'America/Kralendijk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_LA_PAZ = 'America/La_Paz'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_LIMA = 'America/Lima'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_LOS_ANGELES = 'America/Los_Angeles'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_LOWER_PRINCES = 'America/Lower_Princes'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MACEIO = 'America/Maceio'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MANAGUA = 'America/Managua'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MANAUS = 'America/Manaus'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MARIGOT = 'America/Marigot'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MARTINIQUE = 'America/Martinique'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MATAMOROS = 'America/Matamoros'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MAZATLAN = 'America/Mazatlan'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MENOMINEE = 'America/Menominee'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MERIDA = 'America/Merida'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_METLAKATLA = 'America/Metlakatla'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MEXICO_CITY = 'America/Mexico_City'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MIQUELON = 'America/Miquelon'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MONCTON = 'America/Moncton'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MONTERREY = 'America/Monterrey'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MONTEVIDEO = 'America/Montevideo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_MONTSERRAT = 'America/Montserrat'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NASSAU = 'America/Nassau'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NEW_YORK = 'America/New_York'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NIPIGON = 'America/Nipigon'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NOME = 'America/Nome'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NORONHA = 'America/Noronha'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NORTH_DAKOTA_BEULAH = 'America/North_Dakota/Beulah'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NORTH_DAKOTA_CENTER = 'America/North_Dakota/Center'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NORTH_DAKOTA_NEW_SALEM = 'America/North_Dakota/New_Salem'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_NUUK = 'America/Nuuk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_OJINAGA = 'America/Ojinaga'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PANAMA = 'America/Panama'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PANGNIRTUNG = 'America/Pangnirtung'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PARAMARIBO = 'America/Paramaribo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PHOENIX = 'America/Phoenix'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PORT_AU_PRINCE = 'America/Port-au-Prince'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PORT_OF_SPAIN = 'America/Port_of_Spain'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PORTO_VELHO = 'America/Porto_Velho'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PUERTO_RICO = 'America/Puerto_Rico'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_PUNTA_ARENAS = 'America/Punta_Arenas'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_RAINY_RIVER = 'America/Rainy_River'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_RANKIN_INLET = 'America/Rankin_Inlet'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_RECIFE = 'America/Recife'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_REGINA = 'America/Regina'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_RESOLUTE = 'America/Resolute'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_RIO_BRANCO = 'America/Rio_Branco'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_SANTAREM = 'America/Santarem'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_SANTIAGO = 'America/Santiago'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_SANTO_DOMINGO = 'America/Santo_Domingo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_SAO_PAULO = 'America/Sao_Paulo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_SCORESBYSUND = 'America/Scoresbysund'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_SITKA = 'America/Sitka'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_ST_BARTHELEMY = 'America/St_Barthelemy'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_ST_JOHNS = 'America/St_Johns'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_ST_KITTS = 'America/St_Kitts'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_ST_LUCIA = 'America/St_Lucia'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_ST_THOMAS = 'America/St_Thomas'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_ST_VINCENT = 'America/St_Vincent'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_SWIFT_CURRENT = 'America/Swift_Current'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_TEGUCIGALPA = 'America/Tegucigalpa'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_THULE = 'America/Thule'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_THUNDER_BAY = 'America/Thunder_Bay'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_TIJUANA = 'America/Tijuana'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_TORONTO = 'America/Toronto'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_TORTOLA = 'America/Tortola'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_VANCOUVER = 'America/Vancouver'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_WHITEHORSE = 'America/Whitehorse'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_WINNIPEG = 'America/Winnipeg'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_YAKUTAT = 'America/Yakutat'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AMERICA_YELLOWKNIFE = 'America/Yellowknife'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_CASEY = 'Antarctica/Casey'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_DAVIS = 'Antarctica/Davis'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_DUMONTDURVILLE = 'Antarctica/DumontDUrville'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_MACQUARIE = 'Antarctica/Macquarie'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_MAWSON = 'Antarctica/Mawson'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_MCMURDO = 'Antarctica/McMurdo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_PALMER = 'Antarctica/Palmer'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_ROTHERA = 'Antarctica/Rothera'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_SYOWA = 'Antarctica/Syowa'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_TROLL = 'Antarctica/Troll'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ANTARCTICA_VOSTOK = 'Antarctica/Vostok'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ARCTIC_LONGYEARBYEN = 'Arctic/Longyearbyen'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_ADEN = 'Asia/Aden'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_ALMATY = 'Asia/Almaty'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_AMMAN = 'Asia/Amman'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_ANADYR = 'Asia/Anadyr'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_AQTAU = 'Asia/Aqtau'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_AQTOBE = 'Asia/Aqtobe'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_ASHGABAT = 'Asia/Ashgabat'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_ATYRAU = 'Asia/Atyrau'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_BAGHDAD = 'Asia/Baghdad'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_BAHRAIN = 'Asia/Bahrain'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_BAKU = 'Asia/Baku'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_BANGKOK = 'Asia/Bangkok'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_BARNAUL = 'Asia/Barnaul'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_BEIRUT = 'Asia/Beirut'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_BISHKEK = 'Asia/Bishkek'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_BRUNEI = 'Asia/Brunei'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_CHITA = 'Asia/Chita'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_CHOIBALSAN = 'Asia/Choibalsan'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_COLOMBO = 'Asia/Colombo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_DAMASCUS = 'Asia/Damascus'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_DHAKA = 'Asia/Dhaka'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_DILI = 'Asia/Dili'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_DUBAI = 'Asia/Dubai'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_DUSHANBE = 'Asia/Dushanbe'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_FAMAGUSTA = 'Asia/Famagusta'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_GAZA = 'Asia/Gaza'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_HEBRON = 'Asia/Hebron'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_HO_CHI_MINH = 'Asia/Ho_Chi_Minh'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_HONG_KONG = 'Asia/Hong_Kong'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_HOVD = 'Asia/Hovd'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_IRKUTSK = 'Asia/Irkutsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_JAKARTA = 'Asia/Jakarta'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_JAYAPURA = 'Asia/Jayapura'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_JERUSALEM = 'Asia/Jerusalem'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KABUL = 'Asia/Kabul'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KAMCHATKA = 'Asia/Kamchatka'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KARACHI = 'Asia/Karachi'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KATHMANDU = 'Asia/Kathmandu'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KHANDYGA = 'Asia/Khandyga'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KOLKATA = 'Asia/Kolkata'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KRASNOYARSK = 'Asia/Krasnoyarsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KUALA_LUMPUR = 'Asia/Kuala_Lumpur'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KUCHING = 'Asia/Kuching'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_KUWAIT = 'Asia/Kuwait'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_MACAU = 'Asia/Macau'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_MAGADAN = 'Asia/Magadan'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_MAKASSAR = 'Asia/Makassar'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_MANILA = 'Asia/Manila'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_MUSCAT = 'Asia/Muscat'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_NICOSIA = 'Asia/Nicosia'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_NOVOKUZNETSK = 'Asia/Novokuznetsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_NOVOSIBIRSK = 'Asia/Novosibirsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_OMSK = 'Asia/Omsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_ORAL = 'Asia/Oral'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_PHNOM_PENH = 'Asia/Phnom_Penh'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_PONTIANAK = 'Asia/Pontianak'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_PYONGYANG = 'Asia/Pyongyang'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_QATAR = 'Asia/Qatar'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_QOSTANAY = 'Asia/Qostanay'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_QYZYLORDA = 'Asia/Qyzylorda'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_RIYADH = 'Asia/Riyadh'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_SAKHALIN = 'Asia/Sakhalin'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_SAMARKAND = 'Asia/Samarkand'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_SEOUL = 'Asia/Seoul'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_SHANGHAI = 'Asia/Shanghai'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_SINGAPORE = 'Asia/Singapore'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_SREDNEKOLYMSK = 'Asia/Srednekolymsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_TAIPEI = 'Asia/Taipei'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_TASHKENT = 'Asia/Tashkent'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_TBILISI = 'Asia/Tbilisi'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_TEHRAN = 'Asia/Tehran'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_THIMPHU = 'Asia/Thimphu'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_TOKYO = 'Asia/Tokyo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_TOMSK = 'Asia/Tomsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_ULAANBAATAR = 'Asia/Ulaanbaatar'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_URUMQI = 'Asia/Urumqi'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_UST_NERA = 'Asia/Ust-Nera'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_VIENTIANE = 'Asia/Vientiane'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_VLADIVOSTOK = 'Asia/Vladivostok'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_YAKUTSK = 'Asia/Yakutsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_YANGON = 'Asia/Yangon'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_YEKATERINBURG = 'Asia/Yekaterinburg'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ASIA_YEREVAN = 'Asia/Yerevan'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_AZORES = 'Atlantic/Azores'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_BERMUDA = 'Atlantic/Bermuda'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_CANARY = 'Atlantic/Canary'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_CAPE_VERDE = 'Atlantic/Cape_Verde'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_FAROE = 'Atlantic/Faroe'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_MADEIRA = 'Atlantic/Madeira'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_REYKJAVIK = 'Atlantic/Reykjavik'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_SOUTH_GEORGIA = 'Atlantic/South_Georgia'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_ST_HELENA = 'Atlantic/St_Helena'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::ATLANTIC_STANLEY = 'Atlantic/Stanley'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_ADELAIDE = 'Australia/Adelaide'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_BRISBANE = 'Australia/Brisbane'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_BROKEN_HILL = 'Australia/Broken_Hill'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_DARWIN = 'Australia/Darwin'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_EUCLA = 'Australia/Eucla'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_HOBART = 'Australia/Hobart'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_LINDEMAN = 'Australia/Lindeman'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_LORD_HOWE = 'Australia/Lord_Howe'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_MELBOURNE = 'Australia/Melbourne'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_PERTH = 'Australia/Perth'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::AUSTRALIA_SYDNEY = 'Australia/Sydney'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_AMSTERDAM = 'Europe/Amsterdam'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ANDORRA = 'Europe/Andorra'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ASTRAKHAN = 'Europe/Astrakhan'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ATHENS = 'Europe/Athens'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_BELGRADE = 'Europe/Belgrade'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_BERLIN = 'Europe/Berlin'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_BRATISLAVA = 'Europe/Bratislava'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_BRUSSELS = 'Europe/Brussels'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_BUCHAREST = 'Europe/Bucharest'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_BUDAPEST = 'Europe/Budapest'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_BUSINGEN = 'Europe/Busingen'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_CHISINAU = 'Europe/Chisinau'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_COPENHAGEN = 'Europe/Copenhagen'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_DUBLIN = 'Europe/Dublin'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_GIBRALTAR = 'Europe/Gibraltar'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_GUERNSEY = 'Europe/Guernsey'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_HELSINKI = 'Europe/Helsinki'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ISLE_OF_MAN = 'Europe/Isle_of_Man'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ISTANBUL = 'Europe/Istanbul'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_JERSEY = 'Europe/Jersey'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_KALININGRAD = 'Europe/Kaliningrad'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_KIEV = 'Europe/Kiev'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_KIROV = 'Europe/Kirov'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_LISBON = 'Europe/Lisbon'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_LJUBLJANA = 'Europe/Ljubljana'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_LONDON = 'Europe/London'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_LUXEMBOURG = 'Europe/Luxembourg'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_MADRID = 'Europe/Madrid'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_MALTA = 'Europe/Malta'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_MARIEHAMN = 'Europe/Mariehamn'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_MINSK = 'Europe/Minsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_MONACO = 'Europe/Monaco'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_MOSCOW = 'Europe/Moscow'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_OSLO = 'Europe/Oslo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_PARIS = 'Europe/Paris'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_PODGORICA = 'Europe/Podgorica'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_PRAGUE = 'Europe/Prague'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_RIGA = 'Europe/Riga'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ROME = 'Europe/Rome'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_SAMARA = 'Europe/Samara'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_SAN_MARINO = 'Europe/San_Marino'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_SARAJEVO = 'Europe/Sarajevo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_SARATOV = 'Europe/Saratov'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_SIMFEROPOL = 'Europe/Simferopol'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_SKOPJE = 'Europe/Skopje'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_SOFIA = 'Europe/Sofia'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_STOCKHOLM = 'Europe/Stockholm'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_TALLINN = 'Europe/Tallinn'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_TIRANE = 'Europe/Tirane'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ULYANOVSK = 'Europe/Ulyanovsk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_UZHGOROD = 'Europe/Uzhgorod'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_VADUZ = 'Europe/Vaduz'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_VATICAN = 'Europe/Vatican'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_VIENNA = 'Europe/Vienna'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_VILNIUS = 'Europe/Vilnius'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_VOLGOGRAD = 'Europe/Volgograd'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_WARSAW = 'Europe/Warsaw'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ZAGREB = 'Europe/Zagreb'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ZAPOROZHYE = 'Europe/Zaporozhye'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::EUROPE_ZURICH = 'Europe/Zurich'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_ANTANANARIVO = 'Indian/Antananarivo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_CHAGOS = 'Indian/Chagos'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_CHRISTMAS = 'Indian/Christmas'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_COCOS = 'Indian/Cocos'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_COMORO = 'Indian/Comoro'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_KERGUELEN = 'Indian/Kerguelen'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_MAHE = 'Indian/Mahe'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_MALDIVES = 'Indian/Maldives'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_MAURITIUS = 'Indian/Mauritius'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_MAYOTTE = 'Indian/Mayotte'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::INDIAN_REUNION = 'Indian/Reunion'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_APIA = 'Pacific/Apia'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_AUCKLAND = 'Pacific/Auckland'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_BOUGAINVILLE = 'Pacific/Bougainville'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_CHATHAM = 'Pacific/Chatham'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_CHUUK = 'Pacific/Chuuk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_EASTER = 'Pacific/Easter'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_EFATE = 'Pacific/Efate'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_FAKAOFO = 'Pacific/Fakaofo'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_FIJI = 'Pacific/Fiji'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_FUNAFUTI = 'Pacific/Funafuti'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_GALAPAGOS = 'Pacific/Galapagos'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_GAMBIER = 'Pacific/Gambier'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_GUADALCANAL = 'Pacific/Guadalcanal'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_GUAM = 'Pacific/Guam'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_HONOLULU = 'Pacific/Honolulu'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_KANTON = 'Pacific/Kanton'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_KIRITIMATI = 'Pacific/Kiritimati'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_KOSRAE = 'Pacific/Kosrae'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_KWAJALEIN = 'Pacific/Kwajalein'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_MAJURO = 'Pacific/Majuro'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_MARQUESAS = 'Pacific/Marquesas'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_MIDWAY = 'Pacific/Midway'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_NAURU = 'Pacific/Nauru'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_NIUE = 'Pacific/Niue'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_NORFOLK = 'Pacific/Norfolk'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_NOUMEA = 'Pacific/Noumea'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_PAGO_PAGO = 'Pacific/Pago_Pago'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_PALAU = 'Pacific/Palau'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_PITCAIRN = 'Pacific/Pitcairn'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_POHNPEI = 'Pacific/Pohnpei'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_PORT_MORESBY = 'Pacific/Port_Moresby'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_RAROTONGA = 'Pacific/Rarotonga'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_SAIPAN = 'Pacific/Saipan'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_TAHITI = 'Pacific/Tahiti'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_TARAWA = 'Pacific/Tarawa'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_TONGATAPU = 'Pacific/Tongatapu'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_WAKE = 'Pacific/Wake'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::PACIFIC_WALLIS = 'Pacific/Wallis'
```
...
```php
\FireHub\TheCore\Support\Enums\DateTime\TimeZone::UTC = 'UTC'
```
